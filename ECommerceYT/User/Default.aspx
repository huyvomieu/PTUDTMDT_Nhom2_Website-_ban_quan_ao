<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ECommerceYT.User.Default" %>
                ...
                <ItemTemplate>
                    <div class="col-lg-4 col-md-6 pb-1">
                        <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                            <p class="text-right"><%# Eval("ProductCount", "{0} Products") %></p>
                            <a href='<%# "ShopWith.aspx?CategoryName=" + Eval("CategoryName") %>' class="cat-img position-relative overflow-hidden mb-3">
                                <img class="img-fluid" src='<%# ECommerceYT.Utils.GetImageUrl(Eval("CategoryImageUrl")) %>' alt='<%# Eval("CategoryName") %>' style="object-fit: cover; width: 100%; height: 200px;">
                            </a>
